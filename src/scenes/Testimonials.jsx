  ...
  return (
    <section id="testimonials" className="pt-32 pb-16">
      ...
      >
        ...
        <p className="mt-10 ">
          Here is what people are saying about my work. raesent consequat lectus
          orci, eget tincidunt neque hendrerit nec
        </p>
      </motion.div>
      {/* TESTIMONIAL */}
      <div className="md-flex md:justify-between gap-8">
        ...
        >
          ...
          <p className="text-center text-xl">
            Here is what people are saying about my work. raesent consequat
            lectus orci, eget tincidunt neque hendrerit nec
          </p>
        </motion.div>
        <motion.div
